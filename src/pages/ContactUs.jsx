...
const ContactUs = () => {
  ...
  const handleTransmit = () => {
    ...
    const emailSubject = encodeURIComponent(formData.subject || "SmartFund Manager System Inquiry");
  ...
  return (
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 6 } }}>
        ...
        <Box sx={{ mb: 6, textAlign: "center", maxWidth: 600, mx: "auto" }}>
          ...
          <Typography variant="h4" sx={{ fontWeight: 900, color: "text.primary", letterSpacing: -0.5, mb: 1 }}>
            Support Channels
          </Typography>
          <Typography variant="body2" sx={{ fontWeight: 500, color: "text.secondary", lineHeight: 1.6 }}>
            Establish a direct connection with the SmartFund Manager engineering and support teams. Transmit your query below or utilize the provided communication vectors.
          </Typography>
        </Box>
        ...
        <Grid container spacing={4} justifyContent="center">
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              <Typography variant="subtitle2" sx={{ fontWeight: 800, textTransform: 'uppercase', color: 'primary.main', letterSpacing: 0.5, mb: 3 }}>
              ...
              <Stack spacing={3}>
                ...
                <Box>
                  <Typography sx={labelStyle}>Query Classification / Subject</Typography>
                  <TextField
                      fullWidth
                      variant="standard"
          ...
          <Grid item xs={12} md={5}>
            ...
            >
              <Typography variant="subtitle2" sx={{ fontWeight: 800, textTransform: 'uppercase', color: 'text.secondary', letterSpacing: 0.5, mb: 3 }}>
                System Directory
              </Typography>
              ...
              <List sx={{ p: 0 }}>
                <ListItem disableGutters sx={{ alignItems: 'flex-start', mb: 2 }}>
                  ...
                  <ListItemText
                      primary={<Typography sx={labelStyle}>Primary Node Address</Typography>}
                      secondary={
                ...
                <ListItem disableGutters sx={{ alignItems: 'flex-start', mb: 2 }}>
                  ...
                  <ListItemText
                      primary={<Typography sx={labelStyle}>Voice Protocol</Typography>}
                      secondary={
                        <Link href="tel:+1234567890" sx={{ fontWeight: 600, color: 'text.primary', textDecoration: 'none', '&:hover': { color: 'primary.main' }, mt: 0.5, display: 'inline-block' }}>
                          (123) 456-7890
                        </Link>
                      }
                  />
                ...
                <ListItem disableGutters sx={{ alignItems: 'flex-start', mb: 2 }}>
                  ...
                  <ListItemText
                      primary={<Typography sx={labelStyle}>Direct Routing</Typography>}
                      secondary={
                        <Link href="mailto:chakorsudam@gmail.com" sx={{ fontWeight: 600, color: 'text.primary', textDecoration: 'none', '&:hover': { color: 'primary.main' }, mt: 0.5, display: 'inline-block' }}>
                ...
                <ListItem disableGutters sx={{ alignItems: 'flex-start' }}>
                  ...
                  <ListItemText
                      primary={<Typography sx={labelStyle}>Operational Uptime</Typography>}
                      secondary={
                        <Typography variant="body2" sx={{ fontWeight: 600, color: 'text.primary', mt: 0.5 }}>
                          Monday - Friday<br />
